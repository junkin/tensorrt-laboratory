...
def build_engine(
    ...
    if trt_fp16:
        ...
        config_flags = 0
    builder.max_workspace_size = max_workspace_size if max_workspace_size else (1 * 1024 * 1024 * 1024)
    ...
    profile.set_shape(
        input_name,
        min=(batch_size, input_feats, seq_len),
        opt=(max_batch_size, input_feats, seq_len),
